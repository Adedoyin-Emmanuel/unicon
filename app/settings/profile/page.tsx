      ...
      <section className="w-full flex flex-col items-center justify-center mx-auto">
        ...
        <section className="profile w-full p-1 md:p-0 md:w-1/2 xl:w-2/6">
          <section className="w-full flex items-center justify-between mt-5">
            ...
            <button className="bg-primary rounded-[20px] text-sm py-1 px-3 text-white text-center capitalize cursor-pointer hover:bg-secondary transition-colors duration-100 ease-in">
              update
            </button>
          </section>

          <Text
            className="block text-start text-sm text-slate-800"
            noCapitalize={true}
          >
            @emmysoft
          </Text>
          <Text className="block text-start text-sm mt-2">i build stuff</Text>
          <section className="w-full flex flex-col items-start my-5">
            <section className="flex items-center justify-center gap-x-2 my-1">
              ...
              <Text className="text-sm">100 following</Text>
            </section>
            ...
            <section className="flex items-center justify-center gap-x-2 my-1">
              ...
              <Text className="text-sm">50 followers</Text>
            </section>
            <section className="flex items-center justify-center gap-x-2 my-1">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <Text className="text-sm">28 events attended</Text>
            </section>
            ...
            <section className="flex items-center justify-center gap-x-2 my-1">
              ...
              <Text className="text-sm">8 events organized</Text>
            </section>
          </section>
        </section>
      </section>
